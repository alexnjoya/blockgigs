  ...
  return (
    <div className="bg-[#FAFCFF] pt-10 lg:px-28">
      ...
      <div className="flex space-x-4 items-center pt-8">
        ...
        <Link href="/">
          <div className="w-full h-[43px] lg:h-[48px] px-6 py-3 gap-2 rounded-[4px] bg-[#696F8C] font-montserrat font-medium text-[14px] lg:text-[16px] leading-6 text-nowrap text-[#ffffff] text-center">
            Leave a review
          </div>
        </Link>
      </div>
